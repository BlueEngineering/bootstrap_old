...
class SkinBootstrap extends SkinTemplate {
  ...
  public function initPage( OutputPage $out ) {
	...
	'<script type="text/javascript">'."
		...
		// Funktion zum Aufrufen von google analytic
		(function() {
...
<div id="userbar" class="hidden-xs hidden-sm">
  <div class="navbar-inner border-darker hidden-xs hidden-sm">
      <!-- Navbar auf ganzer Bildschirmbreite - links ausgerichtet - bei kleinen Bildschirmenauflösungen wird die Navigation ausgeblendet (hidden-xs und hidden-sm) -->
      <div class="col-md-12 hidden-xs hidden-sm bg-darker darker-color">
       <ul id="tabs-default-lighter" class="nav nav-tabs nav-tabs-darker darker-color">
         <li style="margin-top:10px" class="darker-color"><?php $this->renderNavigation( array( 'EDIT' ) );?></li>
	 <li><?php $this->renderNavigation( array( 'PERSONALNAV' ) );?></li>
 	 ...
 	 <li><?php if ( !isset( $portals['TOOLBOX'] ) ) { $this->renderNavigation( array( 'TOOLBOX' ) );?></li>
         <!--li><?php /*$this->renderNavigation( array( 'SIDEBARNAV' ) );*/ ?></li-->
       </ul>
      </div>
...
//            $this->renderNavigation( array( 'SIDEBARNAV' ) );
      ...
      ?>
      <!--/div-->
      <!--div class="col-md-3 nav nav-tabs nav-tabs-darker bg-darker">
       <div class="nav" style="margin-top:10px;width:100%">
        <?php
...
<!-- Sidebar Ende -->
    ...
    <div id="page-header" class="container-fluid <?php echo $this->data['loggedin'] ? 'signed-in' : 'signed-out'; ?>">
      ...
      <!-- Überschrift / Seitentitel Anfang -->
      <div class="col-xs-9">
       <p class="bs" align="center">
        <h2 class="text-info"><?php echo $this->html( 'sitename' ); ?></h2><br />
	<h4 class="text-info">Ingenieurinnen und Ingenieure mit sozialer und ökologischer Verantwortung.</h4>
       </p>
      </div>
      <!-- Überschrift / Seitentitel Ende -->

      <!-- Hauptnavigation Anfang -->
      <div class="col-xs-12 pull-left">
	  <ul class="nav nav-pills nav-tabs-inverse-dark pull-left searchform-disabled">
                ...
                <!--li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Nav<b class="caret"></b></a>
    ...
    <section id="content" class="mw-body container-fluid <?php echo $userStateClass; ?>">
      ...
      <div class="container-fluid col-xs-12">
       <div class="going-top">
        <a href="#top">TOP<i class="fa fa-level-up fa-fw"></i></a>
       </div>
      <div>
    </section>
    <!-- /content -->
      ...
      <?php
        ...
        if ( file_exists($footerfile) ):
          ?><div id="footer" class="footer container-fluid bg-darker custom-footer" style="width:100%;"><br />
	<?php
            include( $footerfile );
          ?></div><?php
        else:
        ...
        case 'EDIT':
          ...
          if ($navTemp) { ?>
            <div class="actions pull-left nav">
                <a id="b-edit" href="<?php echo $navTemp['href']; ?>" class="btn btn-darker" style="border:0px;"><i class="fa fa-pencil"></i> <?php echo $navTemp['text']; ?></a>
            </div>
        ...
        case 'PAGE':
          ...
          <ul class="nav" role="navigation">
            <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( count($theData) == 0 ) echo ' emptyPortlet'; ?>">
              ...
              ?>
              <a data-toggle="dropdown" class="dropdown-toggle color-white dark-color" role="menu"><i class="fa fa-book"></i> <?php echo htmlspecialchars( $link['text'] ); ?> <b class="caret"></b></a>
                  <?php } ?>
              <?php } ?>
              <ul aria-labelledby="<?php echo $this->msg($theMsg); ?>" role="menu" class="dropdown-menu dark-color" <?php $this->html( 'userlangattributes' ) ?>>
      ...
      ?>
          ...
          <ul class="nav" role="navigation">
            ...
            <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( count($theData) == 0 ) echo ' emptyPortlet'; ?>">
              ...
              <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button"><i class="fa fa-wrench"></i> <?php $this->msg($theMsg) ?> <b class="caret"></b></a>
        ...
        case 'VARIANTS':
          ...
          <?php if (count($theData) > 0) { ?>
            <ul class="nav" role="navigation">
              <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( count($theData) == 0 ) echo ' emptyPortlet'; ?>">
                <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button"><?php $this->msg($theMsg) ?> <b class="caret"></b></a>
                <ul aria-labelledby="<?php echo $this->msg($theMsg); ?>" role="menu" class="dropdown-menu dark-color" <?php $this->html( 'userlangattributes' ) ?>>
        ...
        case 'ACTIONS':
          ...
          if (count($theData) > 0) {
            ?><ul class="nav" role="navigation">
              <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( count($theData) == 0 ) echo ' emptyPortlet'; ?>">
                <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button"><i class="fa fa-flash"></i> <?php echo $this->msg( 'actions' ); ?> <b class="caret"></b></a>
                <ul aria-labelledby="<?php echo $this->msg($theMsg); ?>" role="menu" class="dropdown-menu dark-color" <?php $this->html( 'userlangattributes' ) ?>>
                  <?php foreach ( $theData as $link ):
        ...
        case 'PERSONAL':
          ...
          <ul class="nav pull-left" role="navigation">
            ...
            <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( !$showPersonal ) echo ' emptyPortlet'; ?>">
              <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button">
                <i class="icon-user"></i>
        ...
        case 'PERSONALNAV':
		  ...
		  <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button"><i class="fa fa-user"></i> Personal <b class="caret"></b></a>
          <ul class="dropdown-menu dark-color">
        ...
        case 'SIDEBARNAV':
          ...
          <a data-toggle="dropdown" class="dropdown-toggle color-white" role="menu"><?php echo htmlspecialchars( $name ); ?> <b class="caret"></b></a>
        ...
        case 'SIDEBAR':
          foreach ( $this->data['sidebar'] as $name => $content ) {
            ...
            if ( $wgBootstrapSkinDisplaySidebarNavigation ) { ?>
              <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle color-white" role="button"><?php echo htmlspecialchars( $name ); ?><b class="caret"></b></a>
        ...
        case 'LANGUAGES':
          ...
          <ul class="nav" role="navigation">
            <li class="dropdown" id="p-<?php echo $theMsg; ?>" class="vectorMenu<?php if ( count($theData) == 0 ) echo ' emptyPortlet'; ?>">
              <a data-toggle="dropdown" class="dropdown-toggle brand color-white" role="menu"><?php echo $this->html($theMsg) ?> <b class="caret"></b></a>
